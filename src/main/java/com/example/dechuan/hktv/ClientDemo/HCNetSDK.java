...
// ivms进入检测区域NET_IVMS_ENTER_REGION
    ...
    boolean  NET_DVR_SetDVRMessageCallBack_V31(HikVisionService.FMSGCallBack fMessageCallBack, Pointer pUser);
    NativeLong  NET_DVR_SetupAlarmChan_V41(NativeLong lUserID, NET_DVR_SETUPALARM_PARAM lpSetupParam);
    boolean  NET_DVR_CloseAlarmChan_V41(NativeLong lAlarmHandle);
...
//NET_DVR_SetDVRMessage的扩展
 ...
 int  NET_DVR_StartListen_V30(String sLocalIP, short wLocalPort, HikVisionService.FMSGCallBack DataCallback, Pointer pUserData);
...
//2005-09-15
 boolean  NET_DVR_CaptureJPEGPicture(int lUserID, NativeLong lChannel, NET_DVR_JPEGPARA lpJpegPara, String sPicFileName);
//JPEG抓图到内存
...
//{
//    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(ClientDemo.DLL_PATH+"libs\\hk\\PlayCtrl",
//            PlayCtrl.class);
//
